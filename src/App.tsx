...
const gaiaReleaseTag = import.meta.env.VITE_GAIA_RELEASE_TAG || 'v0.5.0-beta.6';
const gaiaReleaseVersion = import.meta.env.VITE_GAIA_RELEASE_VERSION || '0.5.0-beta.6';
const gaiaReleaseLabel = import.meta.env.VITE_GAIA_RELEASE_LABEL || 'v0.5.0 beta 6';
